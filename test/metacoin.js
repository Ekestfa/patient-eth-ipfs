...
// const TestClient = artifacts.require("ClientFactory")
// contract(TestClient,function(accounts) {
//   return TestClient.deployed().then(function(instance){
//     return instance.registerPatient('x','x');
//   }).then(function(patient){
//     assert.equal(patient.getIpfsHashByPatientName('x'),'y',"dogru")
//   })
// });
